...
#define NOMINAL_CURRENT         23658
#define MOTOR_MAX_SPEED_RPM     4550 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  6.4 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -23658 /*!< Demagnetization current */
