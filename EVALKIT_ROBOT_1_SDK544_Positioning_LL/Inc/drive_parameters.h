...
#define MAX_APPLICATION_SPEED_RPM       4550 /*!< rpm, mechanical */
...
#define SW_DEADTIME_NS                   300 /*!< Dead-time to be inserted  
...
#define PID_TORQUE_KP_DEFAULT         2318       
#define PID_TORQUE_KI_DEFAULT         246
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           2318
...
#define PID_SPEED_KP_DEFAULT          2902/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          960/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define ON_OVER_VOLTAGE                 TURN_OFF_PWM /*!< TURN_OFF_PWM, 
                                                         ...
                                                         TURN_ON_LOW_SIDES */
#endif /* 0 */
#define R_BRAKE_SWITCH_OFF_THRES_V      35
...
#define FINAL_I_ALIGNMENT               13047 /*!< s16A */
